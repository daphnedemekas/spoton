...
import { Settings, Calendar, MapPin, Sparkles, User, ArrowLeft, MapPinned } from "lucide-react";
...
export default function Attended() {
  ...
  const loadAttendedEvents = async () => {
    try {
      ...
      const eventIds = attendedEventIds.map(item => item.event_id);
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {events.length === 0 && (
            <div className="mt-12 text-center">
              ...
              <h2 className="mb-2 text-2xl font-semibold">No attended events yet</h2>
